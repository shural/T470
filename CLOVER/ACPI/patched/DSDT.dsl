 ...
 *
 * Disassembly of DSDT.aml, Tue Jul 30 20:27:01 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F8FD (129277)
 *     Revision         0x02
 *     Checksum         0x9D
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SKL     "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    External (_SB_.PCI0.PWRS, FieldUnitObj)    // (from opcode)
    ...
    Scope (_SB)
    {
        ...
        {
            Add (GINF (Arg0, Zero), SBRG, Local0)
        ...
        Method (INUM, 1, NotSerialized)
        {
            ...
            {
                Add (Local1, GINF (Local3, One), Local1)
                Increment (Local3)
            }
        ...
        Method (GGPE, 1, NotSerialized)
        {
            ...
            Else
            {
                And (ShiftRight (GPEM, Multiply (Local0, 0x02)), 0x03, Local2)
        ...
        Method (GPC0, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (GADR (Local0, 0x02), Multiply (Local1, 0x08), Local2)
        ...
        Method (GPC1, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (Add (GADR (Local0, 0x02), Multiply (Local1, 0x08)), 0x04, Local2)
        ...
        Method (GGPO, 1, Serialized)
        {
            Store (GGRP (Arg0), Local0)
            Store (GNMB (Arg0), Local1)
            Add (GADR (Local0, 0x04), Multiply (ShiftRight (Local1, 0x03), 0x04), Local2)
    ...
    Scope (\)
    {
        ...
        {
            Store (PCRR (Arg0, Arg1), Local0)
            Or (And (Local0, Arg2), Arg3, Local1)
            PCRW (Arg0, Arg1, Local1)
        }
    ...
    Scope (_SB.PCI0)
    {
        Device (GEXP)
        {
            ...
            Method (CSER, 5, Serialized)
            {
                ...
                If (LEqual (Arg4, 0x02))
                {
                    And (One, ShiftRight (OLDV, PINN), RETV)
                }
                Else
                {
                    And (OLDV, Not (ShiftLeft (One, PINN)), NEWV)
                    Or (NEWV, ShiftLeft (Arg3, PINN), NEWV)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC)
        {
            ...
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                ...
                ^HKEY.WGIN ()
                If (LEqual (WLAC, 0x02)){}
                ElseIf (LAnd (ELNK, LEqual (WLAC, One)))
                {
                    Store (Zero, DCWL)
                }
                Else
            ...
            Device (HKEY)
            {
                ...
                Method (INSS, 1, NotSerialized)
                {
                    If (And (Arg0, 0x10000000))
                    {
                        If (IOCP)
                        {
                            ShiftRight (And (Arg0, 0x80), 0x07, Local0)
                            If (LNot (EZRC (Local0)))
                            {
                                Store (Local0, IOST)
                            }
                ...
                Method (VOPP, 1, NotSerialized)
                {
                    ...
                    {
                        If (LOr (LEqual (And (Arg0, 0x03FC), Zero), And (Arg0, 0x03)))
                        {
                            SDPS (One, And (Arg0, 0x03))
                            Store (Zero, Local0)
                            Or (Local0, SDPS (Zero, Zero), Local0)
            ...
            Method (GBIF, 3, NotSerialized)
            {
                ...
                If (Arg2)
                {
                    ...
                    If (Local7)
                    {
                        Multiply (B1B2 (BDC0, BDV1), 0x0A, Local0)
                    }
                    Else
                    {
                        Store (B1B2 (BDC0, BDV1), Local0)
                    }
            ...
            Method (GBST, 4, NotSerialized)
            {
                ...
                ShiftLeft (One, ShiftRight (Arg0, 0x04), Local5)
                Or (BSWA, BSWR, BSWA)
            ...
            Device (BAT0)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    Store (DerefOf (Index (BX0I, One)), Index (BT0I, Zero))
                    Store (DerefOf (Index (BX0I, 0x02)), Index (BT0I, One))
                ...
                {
                    XOr (DerefOf (Index (BX0I, One)), One, Local0)
                ...
                Method (_BTP, 1, NotSerialized)  // _BTP: Battery Trip Point
                {
                    ...
                    {
                        Store (Arg0, Local1)
                        If (LNot (DerefOf (Index (BX0I, One))))
                        {
            ...
            Device (BAT1)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    Store (DerefOf (Index (BX1I, One)), Index (BT1I, Zero))
                    Store (DerefOf (Index (BX1I, 0x02)), Index (BT1I, One))
                ...
                Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                {
                    XOr (DerefOf (Index (BX1I, One)), One, Local0)
                ...
                Method (_BTP, 1, NotSerialized)  // _BTP: Battery Trip Point
                {
                    ...
                    {
                        Store (Arg0, Local1)
                        If (LNot (DerefOf (Index (BX1I, One))))
                        {
                            Divide (Local1, 0x0A, Local0, Local1)
                        }
            ...
            Scope (HKEY)
            {
                Method (SCRQ, 1, Serialized)
                {
                    ...
                    If (LEqual (And (Local0, 0x80000000), Zero))
                    {
    ...
    Method (TBTF, 1, Serialized)
    {
        ...
        Switch (ToInteger (Arg0))
        {
            Case (One)
            {
                And (RPA1, 0x0F, Local0)
            }
            Case (0x02)
            {
                And (RPA2, 0x0F, Local0)
            }
            Case (0x03)
            {
                And (RPA3, 0x0F, Local0)
            }
            Case (0x04)
            {
                And (RPA4, 0x0F, Local0)
            }
            Case (0x05)
            {
                And (RPA5, 0x0F, Local0)
            }
            Case (0x06)
            {
                And (RPA6, 0x0F, Local0)
            }
            Case (0x07)
            {
                And (RPA7, 0x0F, Local0)
            }
            Case (0x08)
            {
                And (RPA8, 0x0F, Local0)
            }
            Case (0x09)
            {
                And (RPA9, 0x0F, Local0)
            }
            Case (0x0A)
            {
                And (RPAA, 0x0F, Local0)
            }
            Case (0x0B)
            {
                And (RPAB, 0x0F, Local0)
            }
            Case (0x0C)
            {
                And (RPAC, 0x0F, Local0)
            }
            Case (0x0D)
            {
                And (RPAD, 0x0F, Local0)
            }
            Case (0x0E)
            {
                And (RPAE, 0x0F, Local0)
            }
            Case (0x0F)
            {
                And (RPAF, 0x0F, Local0)
            }
            Case (0x10)
            {
                And (RPAG, 0x0F, Local0)
            }
            Case (0x11)
            {
                And (RPAH, 0x0F, Local0)
            }
            Case (0x12)
            {
                And (RPAI, 0x0F, Local0)
            }
            Case (0x13)
            {
                And (RPAJ, 0x0F, Local0)
            }
            Case (0x14)
            {
                And (RPAK, 0x0F, Local0)
            }
            Case (0x15)
            {
                Store (Zero, Local0)
    ...
    Method (OPTS, 1, NotSerialized)
    {
        ...
        If (Local0)
        {
            ...
            If (LEqual (Arg0, One))
            {
                ...
                Store (Zero, \_SB.PCI0.LPCB.EC.HFNI)
                Store (Zero, \_SB.PCI0.LPCB.EC.HFSP)
            }
            ...
            If (LEqual (Arg0, 0x03))
            {
                ...
                If (LEqual (FNWK, One))
                {
                    If (H8DR)
                    {
                        Store (Zero, \_SB.PCI0.LPCB.EC.HWFN)
                    }
                    Else
                    {
                        MBEC (0x32, 0xEF, Zero)
            ...
            {
                Store (Zero, \_SB.PCI0.LPCB.EC.HWLB)
            }
            Else
            {
                Store (One, \_SB.PCI0.LPCB.EC.HWLB)
            }

            If (LGreaterEqual (Arg0, 0x03))
            {
                Store (One, \_SB.PCI0.LPCB.EC.HCMU)
            }
    ...
    Method (OWAK, 1, NotSerialized)
    {
        ...
        If (LEqual (Arg0, 0x03))
        {
            ...
            If (LEqual (WLAC, 0x02)){}
            ElseIf (LAnd (\_SB.PCI0.LPCB.EC.ELNK, LEqual (WLAC, One)))
            {
        ...
        {
            ADBG ("_WAK0")
            Store (Zero, \_SB.PCI0.LPCB.EC.HKEY.ANGN)
        ...
        Device (SLPB)
        {
            ...
            Method (_PSW, 1, NotSerialized)  // _PSW: Power State Wake
            {
                If (H8DR)
                {
                    If (Arg0)
                    {
                        Store (One, ^^PCI0.LPCB.EC.HWFN)
                    }
                    Else
                    {
                        Store (Zero, ^^PCI0.LPCB.EC.HWFN)
                    }
                }
                ElseIf (Arg0)
                {
    ...
    {
        SMI (0x18, And (Arg0, 0xFF), And (Arg1, 0xFF), And (Arg2, 0xFF), Zero)
    }

    Method (SPMS, 1, NotSerialized)
    {
        SMI (0x19, And (Arg0, 0xFF), Zero, Zero, Zero)
    }
    ...
    Scope (_SB)
    {
        ...
        Device (MEM)
        {
            ...
            CreateDWordField (MEMS, \_SB.MEM._Y32._LEN, MC0L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y33._LEN, MC4L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y34._LEN, MC8L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y35._LEN, MCCL)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y36._LEN, MD0L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y37._LEN, MD4L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y38._LEN, MD8L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y39._LEN, MDCL)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y3A._LEN, ME0L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y3B._LEN, ME4L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y3C._LEN, ME8L)  // _LEN: Length
            CreateDWordField (MEMS, \_SB.MEM._Y3D._LEN, MECL)  // _LEN: Length
            CreateBitField (MEMS, \_SB.MEM._Y32._RW, MC0W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y33._RW, MC4W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y34._RW, MC8W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y35._RW, MCCW)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y36._RW, MD0W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y37._RW, MD4W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y38._RW, MD8W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y39._RW, MDCW)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y3A._RW, ME0W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y3B._RW, ME4W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y3C._RW, ME8W)  // _RW_: Read-Write Status
            CreateBitField (MEMS, \_SB.MEM._Y3D._RW, MECW)  // _RW_: Read-Write Status
            CreateDWordField (MEMS, \_SB.MEM._Y3E._BAS, MEB1)  // _BAS: Base Address
            CreateDWordField (MEMS, \_SB.MEM._Y3E._LEN, MEL1)  // _LEN: Length
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.PM1L, 0x03, Local0)
                If (Local0)
                {
                    Store (0x4000, MC0L)
                    If (And (Local0, 0x02))
        ...
        Scope (I2C0)
        {
            Device (NFC1)
            {
                ...
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    ...
                    {
                        If (LAnd (LEqual (GGIV (0x02030016), Zero), LEqual (NFCF, Zero)))
                        {
                            Return (0x0F)
                        }
                    }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (SIO)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (BUF, \_SB.PCI0.LPCB.SIO._CRS._Y3F._BAS, SXB)  // _BAS: Base Address
                Store (SXRB, SXB)
                CreateDWordField (BUF, \_SB.PCI0.LPCB.SIO._CRS._Y3F._LEN, SXL)  // _LEN: Length
                Store (SXRS, SXL)
                Return (BUF)
            }
        }
...
//            Notify (KBD, 0x036A)
            Notify (KBD, 0x30)        // Hope this is F17
        ...
        Scope (\_SB.PCI0.LPCB.EC)
        {
            Method (_Q45, 0, NotSerialized)  // _Qxx: EC Query
            {
                ...
                If (DOCD)
                {
                    Sleep (0x64)
                    ^HKEY.MHKQ (0x4010)
                    Notify (^^^XHC.RHUB.HS02, 0x09)
                    Notify (^^^XHC.RHUB.SS02, 0x09)
                }
                Else
                {
                    Sleep (0x64)
...
//                Notify (KBD, 0x0406)	// VoodooPS2Controller
                Notify (KBD, 0x10)	// ApplePS2SmartPad
            }
...
//                Notify (KBD, 0x0405)
            ...
            Method (BFRQ, 0, NotSerialized)
            {
                ...
                Or (Local0, ShiftLeft (Local1, 0x09), Local0)
        ...
        Scope (HKEY)
        {
            ...
            {
                Store (Arg0, Local0)
                If (LAnd (LGreaterEqual (OSYS, 0x07DF), LEqual (Local0, One)))
                {
                    Store (0x02, Local0)
                }
        ...
        Scope (HKEY)
        {
            ...
            Method (WPWS, 0, NotSerialized)
            {
                ...
                Else
                {
                    ShiftRight (And (RBEC (0x3A), 0x40), 0x06, Local0)
                }
            ...
            Method (BPWS, 0, NotSerialized)
            {
                ...
                Else
                {
                    ShiftRight (And (RBEC (0x3A), 0x10), 0x04, Local0)
                }
    ...
    Scope (_SB.PCI0.LPCB.EC.HKEY)
    {
        ...
        Method (MHAT, 1, NotSerialized)
        {
            If (LAnd (WNTF, TATC))
            {
                ...
                And (Arg0, 0x0F, TCFA)
                And (ShiftRight (Arg0, 0x04), 0x0F, TCTA)
                And (ShiftRight (Arg0, 0x08), 0x0F, TCFD)
                And (ShiftRight (Arg0, 0x0C), 0x0F, TCTD)
                ATMC ()
        ...
        Method (ATMV, 1, NotSerialized)
        {
            ...
            And (ShiftRight (Arg0, 0x04), 0x0F, Local2)
            Store (TNTT, Local0)
        ...
        Method (DYTC, 1, Serialized)
        {
            ...
            If (LAnd (WNTF, TATC))
            {
                Switch (ToInteger (And (Local0, 0x01FF)))
                {
                    ...
                    {
                        Store (0x0100, Local1)
                        Or (Local1, 0x30000000, Local1)
                        Or (Local1, 0x00010000, Local1)
                    ...
                    Case (One)
                    {
                        ...
                        Store (VSTD, Local5)
                        Or (Local5, ShiftLeft (VCQL, One), Local5)
                        Or (Local5, ShiftLeft (VTIO, 0x02), Local5)
                        Or (Local5, ShiftLeft (VMYH, 0x03), Local5)
                        Or (Local5, ShiftLeft (VSTP, 0x04), Local5)
                        Or (Local5, ShiftLeft (VCQH, 0x05), Local5)
                        Or (Local5, ShiftLeft (VDCC, 0x06), Local5)
                        Or (Local5, ShiftLeft (VSFN, 0x07), Local5)
                        Or (Local5, ShiftLeft (VDMC, 0x08), Local5)
                        Or (Local5, ShiftLeft (VFHP, 0x09), Local5)
                        Or (Local5, ShiftLeft (VIFC, 0x0A), Local5)
                        Or (Local5, ShiftLeft (VMSC, 0x0C), Local5)
                        ShiftLeft (CICF, 0x08, Local1)
                        If (LNotEqual (CICF, 0x03))
                        {
                            Store (0x0F, CICM)
                        }

                        Or (Local1, ShiftLeft (CICM, 0x0C), Local1)
                        Or (Local1, ShiftLeft (Local5, 0x10), Local1)
                        Or (Local1, One, Local1)
                        If (DHKC)
                        {
                            MHKQ (0x6032)
                    ...
                    Case (0x03)
                    {
                        ShiftLeft (FCAP, 0x10, Local1)
                        Or (Local1, One, Local1)
                    }
                    Case (0x04)
                    {
                        ShiftLeft (MCAP, 0x10, Local1)
                        Or (Local1, One, Local1)
                    }
                    Case (0x05)
                    {
        ...
        {
            Store (Arg0, GPTL)
            If (LAnd (ANGN, LNotEqual (VPON, Zero)))
            {
        ...
        Method (ATMC, 0, NotSerialized)
        {
            If (LAnd (WNTF, TATC))
            {
                If (HPAC)
                {
                    Store (TCFA, Local0)
                    Store (TCTA, Local1)
                    Or (ShiftLeft (Local1, 0x04), Local0, Local2)
        ...
        ThermalZone (THM0)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                Else
                {
                    ...
                    And (RBEC (0x8A), 0x7F, Local1)
                    And (RBEC (0x8B), 0x7F, Local2)
                }
